...
def approve_learner_credit_requests(
    ...
    try:
        ...
        approved_requests_to_update = _prepare_requests_for_update(approved_requests_map, reviewer)
    ...
    if approved_requests_to_update:
        with transaction.atomic():
            approved_requests = _update_and_refresh_requests(
                approved_requests_to_update, ['state', 'assignment', 'reviewer', 'reviewed_at']
            )
    ...
    return {"approved": approved_requests, "failed_approval": failed_requests}
