...
class LearnerCreditRequest(SubsidyRequest):
    ...
    subsidy_access_policy = models.ForeignKey(
        ...
        null=True,
        blank=True,
        help_text="The SubsidyAccessPolicy that this learner credit request is associated with.",
    )
...
class LearnerCreditRequestConfiguration(TimeStampedModel):
    ...
    policy_uuid = models.OneToOneField(
        SubsidyAccessPolicy,
        related_name="learner_credit_request_config",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    )
