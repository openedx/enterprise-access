...
class LearnerCreditRequestTests(TestCase):
    ...
    def test_approve_success(self):
        ...
        self.assertEqual(self.learner_credit_request.state, SubsidyRequestStates.PENDING)
...
class LearnerCreditRequestConfigurationTests(TestCase):
    ...
    def setUp(self):
        ...
        """
        self.subsidy_access_policy = PerLearnerEnrollmentCapLearnerCreditAccessPolicyFactory()
        self.config = LearnerCreditRequestConfiguration.objects.create(
            policy_uuid=self.subsidy_access_policy
        )
    ...
    def test_policy_association(self):
        ...
        """
        self.assertEqual(self.config.policy_uuid, self.subsidy_access_policy)
        self.assertEqual(self.config.policy_uuid.uuid, self.subsidy_access_policy.uuid)
