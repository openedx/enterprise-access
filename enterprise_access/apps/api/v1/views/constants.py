...
CHECKOUT_INTENT_EXAMPLES = [
    ...
    OpenApiExample(
        ...
        value={
            ...
            'user': 1,
            'status': 'errored_stripe_checkout',
...
PATCH_REQUEST_EXAMPLES = [
    OpenApiExample(
        ...
        description='Updates status after successful payment',
        value={
            'status': 'paid'
        },
        request_only=True,
    ...
    OpenApiExample(
        ...
        description='Updates status to error with descriptive message',
        value={
            'status': 'errored_stripe_checkout',
    ...
    OpenApiExample(
        ...
        description='Add or update metadata without changing status',
        value={
            'metadata': {
                'retry_count': 2,
                'last_error': 'timeout',
    ...
    400: OpenApiResponse(
        ...
        examples=[
            OpenApiExample(
                ...
                value={
                    'status': ['Invalid state transition from created to fulfilled']
                }
            ),
            OpenApiExample(
                'Invalid Status Value',
                value={
                    'status': ['Invalid status: completed']
                }
            ),
        ]
    ),
