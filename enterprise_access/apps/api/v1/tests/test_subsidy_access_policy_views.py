...
class TestAuthenticatedPolicyCRUDViews(CRUDViewTestMixin, APITestWithMocks):
    ...
    def setup_mocks(self):
        ...
        subsidy_client.get('active_datetime').return_value = yesterday
        subsidy_client.get('expiration_datetime').return_value = yesterday
        subsidy_client.get('is_active').return_value = True
