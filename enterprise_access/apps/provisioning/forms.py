...
from crispy_forms.layout import ButtonHolder, Fieldset, Layout, Submit, Row, Div
...
PLAN_PRODUCT_CHOICES = [
    (1, 'Standard Paid'),
]

class ProvisionNewCustomerWorkflowAdminForm(forms.Form):
    """
    ...
    catalog_query_id = forms.ChoiceField(label='Catalog query', required=True, choices=CATALOG_QUERY_CHOICES)
    ...
    plan_product_id = forms.ChoiceField(label='Product ID', required=True, choices=PLAN_PRODUCT_CHOICES)
