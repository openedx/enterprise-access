...
class TestSelfServiceSubscriptionRenewal(TestCase):
    ...
    def test_self_service_subscription_renewal_relationships(self):
        ...
        self.assertEqual(renewal.stripe_event_data, event_data)
        ...
        related_renewals_from_event = SelfServiceSubscriptionRenewal.objects.filter(stripe_event_data=event_data)
