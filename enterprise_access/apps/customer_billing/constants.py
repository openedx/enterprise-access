...
ALLOWED_CHECKOUT_INTENT_STATE_TRANSITIONS = {
    CheckoutIntentState.CREATED: [CheckoutIntentState.PAID, CheckoutIntentState.ERRORED_STRIPE_CHECKOUT],
    CheckoutIntentState.PAID: [CheckoutIntentState.FULFILLED, CheckoutIntentState.ERRORED_PROVISIONING],
    CheckoutIntentState.ERRORED_STRIPE_CHECKOUT: [CheckoutIntentState.PAID],
    CheckoutIntentState.ERRORED_PROVISIONING: [CheckoutIntentState.PAID],
