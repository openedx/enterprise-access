...
from .constants import INTENT_RESERVATION_DURATION_MINUTES, SLUG_RESERVATION_DURATION_MINUTES, CheckoutIntentState
...
class EnterpriseSlugReservation(TimeStampedModel):
    """
    DEPRECATED. See the ``CheckoutIntent`` model.
...
class CheckoutIntent(TimeStampedModel):
    ...
    This model replaces EnterpriseSlugReservation with a more comprehensive
    approach that:
